...
export default function MermaidFlowSidebar({ blocks, activeBlockId, onSelect }: Props) {
  return (
    <aside
      style={{
        width: 280,
          ...
          return (
            <button
              ...
              style={{
                ...
                background: active ? '#2d250c' : '#0f172a',
            ...
            >
              <div style={{ fontSize: 12, fontWeight: 700 }}>{block.title}</div>
